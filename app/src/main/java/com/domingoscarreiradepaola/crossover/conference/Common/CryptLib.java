...
public class CryptLib {
    ...
    public static final String IV = "Domingoscdp12345";
    public static final String DEFAULT_KEY = "Domingosdp1234";
    ...
    public String decrypt(String value, String key) throws IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, InvalidKeyException, UnsupportedEncodingException {
